...
(function () {
  ...
  // -- AUTH BYPASS MODE --
  // Auth gating disabled for content review. All pages will behave
  // as if a logged-in ASPA+ admin member is viewing them.
  // To restore auth, revert this commit.

  var _fakeSession = { user: { id: 'bypass', email: 'review@aspa.org' } };
  var _fakeProfile = { id: 'bypass', full_name: 'Content Reviewer', is_admin: true };

  // -- Globals --
  window._supabase        = null;
  window._supabaseSession = _fakeSession;
  window._memberProfile   = _fakeProfile;
  ...
  script.onload = function () {
    ...
    window._supabase = sb;
    _dispatch(_fakeSession, _fakeProfile);
  };
